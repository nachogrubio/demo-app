...
var InternalAzureLogger = /** @class */ (function () {
    function InternalAzureLogger() {
        ...
        logger_1.setLogLevel("verbose"); // Verbose so we can control log level in our side
        ...
        logger_1.AzureLogger.log = function () {
            var args = [];
            for (var _i = 0; _i < arguments.length; _i++) {
                args[_i] = arguments[_i];
            }
            if (logToFile) {
                _this._storeToDisk(args);
            }
            if (logToConsole) {
                console.log.apply(console, args);
            }
        };
        this.logger = logger_1.createClientLogger('ApplicationInsights');
        if (logToFile) {
